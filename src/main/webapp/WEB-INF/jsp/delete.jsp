...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <p> ${msj} </p>
            <form:form method="POST" action="/account/delete" modelAttribute="account">
                <table >        
                    <tr>    
                    ...
                    <tr>    
                        ...
                        <td><form:input path="patronymic" readonly="true"/></td> 
                    </tr>
                    <tr>    
                        <td><form:label path="pin">Pin</form:label></td>
                        <td><form:input path="pin" readonly="true"/></td>
                    </tr>   
                    <tr>    
