    ...
    <body>
        ...
        <form:form method="POST" action="/account/add" modelAttribute="account">
            <table >        
                ...
                <tr>    
                    <td><form:label path="ownerName">Card Owner Name</form:label></td>
                    <td><form:input path="ownerName"/></td> 
                </tr>  
                <tr>    
                    <td><form:label path="ownerSurname">Card Owner Surname</form:label></td>
                    <td><form:input path="ownerSurname"/></td> 
                </tr>
                <tr>    
                ...
                <tr>    
                    <td><form:label path="discreationaryData">Discreationary Data</form:label></td>
                    <td><form:input path="discreationaryData"/></td> 
                </tr>  
                <tr>    
                    <td> </td>    
